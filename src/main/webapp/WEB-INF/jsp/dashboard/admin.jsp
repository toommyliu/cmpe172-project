...
<style>
    #provider-scrollspy .nav-link {
        color: var(--bs-secondary);
        border-radius: 0.5rem;
        padding: 0.5rem 1rem;
    }

    #provider-scrollspy .nav-link:hover {
        background-color: var(--bs-light);
    }

    #provider-scrollspy .nav-link.active {
        background-color: var(--bs-primary);
        color: white;
    }

    #provider-scrollspy .nav-link.disabled {
        pointer-events: none;
    }
    ...
    <div class="dashboard-wrapper">
        ...
        <div id="provider-tab-content" data-tab="provider">
            <div class="row g-4">
                ...
                <div class="col-lg-9">
                    <div id="provider-info" class="card border-0 mb-5">
                    ...
                    <div id="weekly-hours" class="card border-0 mb-5">
                        <div class="card-header bg-white border-bottom py-3">
                    ...
                    <div id="date-overrides" class="card border-0 mb-5">
                        <div class="card-header bg-white border-bottom py-3">
        ...
        <div id="users-tab-content" class="hidden" data-tab="users">
            <div class="card border-0">
                <div class="card-header bg-white border-bottom py-3">
